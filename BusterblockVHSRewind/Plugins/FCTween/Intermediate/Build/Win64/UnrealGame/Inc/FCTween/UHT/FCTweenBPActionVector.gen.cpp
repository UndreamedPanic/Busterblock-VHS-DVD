...
void FTweenUpdateVectorOutputPin_DelegateWrapper(const FMulticastScriptDelegate& TweenUpdateVectorOutputPin, FVector Value)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFCTweenBPActionVector_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFCTweenBPActionVector_TweenVector, "TweenVector" }, // 1040496738
		{ &Z_Construct_UFunction_UFCTweenBPActionVector_TweenVectorCustomCurve, "TweenVectorCustomCurve" }, // 2124111885
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFCTweenBPActionVector_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionVector_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionVector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFCTweenBPActionVector, UFCTweenBPActionVector::StaticClass, TEXT("UFCTweenBPActionVector"), &Z_Registration_Info_UClass_UFCTweenBPActionVector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFCTweenBPActionVector), 4279074132U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionVector_h_2954178383(TEXT("/Script/FCTween"),
		Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionVector_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionVector_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
