...
void FTweenUpdateQuatOutputPin_DelegateWrapper(const FMulticastScriptDelegate& TweenUpdateQuatOutputPin, FQuat Value)
{
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UFCTweenBPActionQuat_TweenQuat_Statics::NewProp_EaseType = { "EaseType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCTweenBPActionQuat_eventTweenQuat_Parms, EaseType), Z_Construct_UEnum_FCTween_EFCEase, METADATA_PARAMS(0, nullptr) }; // 3798122449
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFCTweenBPActionQuat_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFCTweenBPActionQuat_TweenQuat, "TweenQuat" }, // 2130504871
		{ &Z_Construct_UFunction_UFCTweenBPActionQuat_TweenQuatCustomCurve, "TweenQuatCustomCurve" }, // 3180543505
		{ &Z_Construct_UFunction_UFCTweenBPActionQuat_TweenQuatFromRotator, "TweenQuatFromRotator" }, // 3050317497
		{ &Z_Construct_UFunction_UFCTweenBPActionQuat_TweenQuatFromRotatorCustomCurve, "TweenQuatFromRotatorCustomCurve" }, // 4202927426
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFCTweenBPActionQuat_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionQuat_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionQuat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFCTweenBPActionQuat, UFCTweenBPActionQuat::StaticClass, TEXT("UFCTweenBPActionQuat"), &Z_Registration_Info_UClass_UFCTweenBPActionQuat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFCTweenBPActionQuat), 1738673920U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionQuat_h_1307065146(TEXT("/Script/FCTween"),
		Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionQuat_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionQuat_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
