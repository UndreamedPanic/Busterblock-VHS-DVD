...
void FTweenEventOutputPin_DelegateWrapper(const FMulticastScriptDelegate& TweenEventOutputPin)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFCTweenBPAction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFCTweenBPAction_Pause, "Pause" }, // 717265392
		{ &Z_Construct_UFunction_UFCTweenBPAction_Restart, "Restart" }, // 1863258630
		{ &Z_Construct_UFunction_UFCTweenBPAction_SetTimeMultiplier, "SetTimeMultiplier" }, // 2374060159
		{ &Z_Construct_UFunction_UFCTweenBPAction_Stop, "Stop" }, // 983674287
		{ &Z_Construct_UFunction_UFCTweenBPAction_Unpause, "Unpause" }, // 3403413831
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFCTweenBPAction_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPAction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPAction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFCTweenBPAction, UFCTweenBPAction::StaticClass, TEXT("UFCTweenBPAction"), &Z_Registration_Info_UClass_UFCTweenBPAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFCTweenBPAction), 2454066646U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPAction_h_2140330578(TEXT("/Script/FCTween"),
		Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPAction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPAction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
