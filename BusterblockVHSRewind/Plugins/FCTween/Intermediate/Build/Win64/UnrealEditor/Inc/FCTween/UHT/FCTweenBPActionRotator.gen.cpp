...
void FTweenUpdateRotatorOutputPin_DelegateWrapper(const FMulticastScriptDelegate& TweenUpdateRotatorOutputPin, FRotator Value)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFCTweenBPActionRotator_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFCTweenBPActionRotator_TweenRotator, "TweenRotator" }, // 1672732564
		{ &Z_Construct_UFunction_UFCTweenBPActionRotator_TweenRotatorCustomCurve, "TweenRotatorCustomCurve" }, // 394076778
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFCTweenBPActionRotator_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UFCTweenBPActionRotator_Statics::NewProp_ApplyEasing = { "ApplyEasing", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFCTweenBPActionRotator, ApplyEasing), Z_Construct_UDelegateFunction_FCTween_TweenUpdateRotatorOutputPin__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFCTweenBPActionRotator_Statics::NewProp_ApplyEasing_MetaData), Z_Construct_UClass_UFCTweenBPActionRotator_Statics::NewProp_ApplyEasing_MetaData) }; // 2862898384
	...
	struct Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionRotator_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionRotator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFCTweenBPActionRotator, UFCTweenBPActionRotator::StaticClass, TEXT("UFCTweenBPActionRotator"), &Z_Registration_Info_UClass_UFCTweenBPActionRotator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFCTweenBPActionRotator), 1570567438U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionRotator_h_1498514958(TEXT("/Script/FCTween"),
		Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionRotator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_music_OneDrive_Documents_Unreal_Projects_Emerald_PokemonEmerald_Plugins_FCTween_Source_FCTween_Public_Blueprints_FCTweenBPActionRotator_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
